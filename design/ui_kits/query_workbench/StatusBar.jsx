function StatusBar({ block = '19,482,901', latency = '142 ms', node = 'reth.local · synced', user = 'jsmith@stevens.edu' }) {
  return (
    <div style={{ height: 28, background: '#1E2329', borderTop: '1px solid #1A1F25',
                  display: 'flex', alignItems: 'center', padding: '0 14px', gap: 14,
                  fontFamily: 'var(--font-mono)', fontSize: 11, color: '#949594',
